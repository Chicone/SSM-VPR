...
## Installation
The code has been tested on Ubuntu 18.04 and Python 3.6.6
For installation just download or clone the directory structure. Installation of the following libraries and possibly others may be necessary:    
