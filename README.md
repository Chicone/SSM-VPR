...
- STAGE I: Sets the image size employed during the *image database filtering stage* of the pipeline (default is optimum for the datasets used in our paper, see citation section). The filtering method (architecture) can also be selected. Currently there are four options: (1) based on layer *conv_5_2* of the VGG16 architecture,  (2) ResNet,  (3) GoogLeNet and (4) the [NetVLAD](https://arxiv.org/abs/1511.07247) architecture.   
